...
# [All your existing view functions remain exactly the same]
...
def view_students(request, course_id):
    course = get_object_or_404(Course, id=course_id)
    students = course.students.all()  # Access the students related to the course
    return render(request, 'courses/view_students.html', {'course': course, 'students': students})
...
# Class-based Views for Course List and Detail
